// The tool-dependency module. See tools.go for why it is separate from the
// runtime module at the repository root.
module github.com/karlkfi/claude-spill-guard/tools
