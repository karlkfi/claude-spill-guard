...
Eighteen Python files here are this repo's own, and seventeen of them are entry
...
**No gate asserts any of this, on purpose.** None of the eighteen is invoked by
path: the seventeen entry points run as `$(PYTHON) scripts/x.py` from the
